...
import { LERP_TOKEN_CONTRACT_ADDRESS, LERP_TOKEN_ABI, LOCAL_LERP_PUBLIC_CONFIG, PublicRealmConfig } from './GLOBAL_CONFIG';
...
async function testCompute() {
	...
	const configData = LOCAL_LERP_PUBLIC_CONFIG;
